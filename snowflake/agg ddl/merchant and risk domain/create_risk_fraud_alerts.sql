CREATE OR REPLACE TABLE ABC_BANK.AGG.RISK_FRAUD_ALERTS
(
    ...
    CONSTRAINT FK_ALERT_TRANSACTION
        ...
        REFERENCES ABC_BANK.AGG.BANK_TRANSACTIONS (TRANSACTION_ID),

    CONSTRAINT FK_ALERT_EMPLOYEE
        FOREIGN KEY (ASSIGNEE_EMP_ID)
        REFERENCES ABC_BANK.AGG.ORG_EMPLOYEES (EMPLOYEE_ID),
